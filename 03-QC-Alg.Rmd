...
<figure style="float: right; width: 30%;">
  <img src="https://www.daviddeutsch.org.uk/wp-content/uploads/2013/12/david-home-e1594943580574.jpg" alt="David Deutsch (Resource: Official site)" />
  <figcaption>David Deutsch (Resource: Official site)</figcaption>
</figure>
...
|Constant|Balanced|
|:------:|:-----:|
|![](fig/fig56.png){width=50%}|![](fig/fig57.png){width=50%}|
|\[f(0)=f(1)=0\]|\[f(0)=0,f(1)=1\]|
|![](fig/fig58.png){width=50%}|![](fig/fig59.png){width=50%}|

...
Which of the following states:
  ...
  a. \( |00101\rangle \)  
  a. \( |++\rangle =\frac{1}{\sqrt{2}} (|00\rangle + |01\rangle + |10\rangle + |11\rangle) \)  
  a. \( \frac{1}{\sqrt{2}} (|01\rangle + |10\rangle) \)  
  a. \( |w_4\rangle = \frac{1}{\sqrt{2}} (|0001\rangle + |0010\rangle + |0100\rangle + |1000\rangle) \)  


1. Are these states superpositions in the standard basis?
2. Are these states superpositions in the Hadamard basis \( \{ |+\rangle, |-\rangle \} \), where: \( |+\rangle = \frac{1}{\sqrt{2}} (|0\rangle + |1\rangle) \) and \( |-\rangle = \frac{1}{\sqrt{2}} (|0\rangle - |1\rangle) \)?
3. Are these states entangled?
